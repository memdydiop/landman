...
new #[Layout('layouts.front')] #[Title('Accueil — BTP, Aménagement, Lotissement')] class extends Component {
    ...
    public function render(): \Illuminate\View\View
    {
        ...
        if ($testimonials->isEmpty()) {
            $testimonials = collect([(object) ['name' => 'Kouassi Jean — Cocody', 'role' => 'Propriétaire Villa 4 pièces', 'content' => 'SIBEA-CI a livré notre villa dans les délais, avec un suivi VRD impeccable et un ACD sécurisé. Une équipe réactive et professionnelle.', 'rating' => 5, 'avatar_path' => null], (object) ['name' => 'Awa Koné — Bingerville', 'role' => 'Gérante PME', 'content' => 'Lotissement Abatta : viabilisation et ACD obtenus sans accroc. SIBEA-CI maîtrise le foncier.', 'rating' => 5, 'avatar_path' => null], (object) ['name' => 'Yao Kouamé — Bouaké', 'role' => 'Conducteur de Travaux', 'content' => 'Collaboration BTP fluide, respect du budget et délais. Je recommande SIBEA-CI.', 'rating' => 5, 'avatar_path' => null]]);
        }
        if ($partners->isEmpty()) {
